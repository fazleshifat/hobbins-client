...
const Review = () => {
    return (
        <div className="max-w-[1300px] mx-auto flex flex-col items-center justify-center overflow-hidden dark:bg-none dark:bg-gray-800 dark:border-l-6 dark:border-l-indigo-200 dark:border-t-0 bg-gradient-to-t from-indigo-200 to-bg-base-300 border-t-6 border-t-indigo-200 rounded-3xl py-20 px-6">
